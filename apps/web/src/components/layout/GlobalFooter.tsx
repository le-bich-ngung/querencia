    ...
    <footer style={{ borderTop: '1px solid rgba(0,0,0,0.07)', padding: '14px 24px', background: '#fafaf8' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 0 }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="22 22 72 72" width="13" height="13" style={{ flexShrink: 0, display: 'inline-block', verticalAlign: 'text-bottom', marginRight: 2 }}>
          ...
          <span style={{ fontSize: '0.7rem', color: '#bbb', marginLeft: 10 }}>Ã‚Â© 2026 Ã‚Â· All rights reserved</span>
        </div>

        <span style={{ fontSize: '0.7rem', color: '#aaa', textAlign: 'center', flex: 1, padding: '0 16px' }}>
          Querencia khÃƒÂ´ng quÃ¡ÂºÂ£ng cÃƒÂ¡o vÃƒÂ  khÃƒÂ´ng bÃƒÂ¡n dÃ¡Â»Â¯ liÃ¡Â»â€¡u. NguÃ¡Â»â€œn thu duy nhÃ¡ÂºÂ¥t Ã„â€˜Ã¡ÂºÂ¿n tÃ¡Â»Â« cÃƒÂ¡c cÃƒÂ´ng cÃ¡Â»Â¥ trÃ¡ÂºÂ£ phÃƒÂ­.
        </span>
