    ...
    <footer style={{ borderTop: '1px solid rgba(0,0,0,0.07)', padding: '14px 24px', background: '#fafaf8' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="22 22 72 72" width="13" height="13" style={{ flexShrink: 0, display: 'block' }}>
          ...
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 400, fontSize: '0.85rem', display: 'inline-flex', alignItems: 'center' }}>
            <span style={{ color: '#111', opacity: 0.45 }}>ueren</span>
            <span style={{ color: SAGE }}>c</span>
            <span style={{ position: 'relative', display: 'inline-block', color: SAGE }}>
              i
              <svg style={{ position: 'absolute', left: '60%', top: '0.1em', transform: 'translateX(-50%)', width: '0.28em', height: '0.28em' }} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <span style={{ fontSize: '0.7rem', color: '#bbb', marginLeft: 4 }}>© 2026 · All rights reserved</span>
        </div>
