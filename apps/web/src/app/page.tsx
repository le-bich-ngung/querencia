...
export default function HomePage() {
  ...
  var LogoSVG = function(props) {
    ...
    var animStyle = props.animated ? { strokeDasharray: '203 9999', strokeDashoffset: 203, animation: 'waveRun 4s linear infinite', animationFillMode: 'both', animationDelay: '0s' } : {};
    return (
