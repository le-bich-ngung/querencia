...
function LetterDrop() {
  ...
  // MÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€ÃƒÆ’Ã‚Â¹i chÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€Ãƒâ€šÃ‚Â» rÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€Ãƒâ€šÃ‚Â¢t cÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÆ’Ã‚Â­ch nhau 0.18s, shimmer sau khi tÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬ËœÃƒÆ’Ã¢â‚¬Ëœt cÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬ËœÃƒÆ’Ã‚Âº ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÆ’Ã‚Â¦ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÆ’Ã‚Âº rÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€Ãƒâ€šÃ‚Â¢t
  // 8 chÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€Ãƒâ€šÃ‚Â» x 0.18s = 1.44s + 0.8s rÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€Ãƒâ€šÃ‚Â¢t = 2.24s trÃƒÂ¢Ã¢â‚¬Â¢Ã…Â¾ÃƒÂ¢Ã¢â‚¬â€œÃ¢â‚¬ËœÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€Ãƒâ€šÃ‚Â¢c shimmer
  return (
  ...
  return (
    <div>
      ...
      <section style={{ minHeight: '100vh', background: '#070908', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '100px 24px 60px', textAlign: 'center', overflow: 'hidden', position: 'relative' }}>
        ...
        {/* Logo lÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€Ãƒâ€šÃ‚Â¢n + wordmark cÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬Â¢Ã‚Â£ng hÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÆ’Ã‚Â¡ng */}
        ...
        {/* Typewriter quote - slogan chÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒâ€šÃ‚Â¡nh thÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€ÃƒÂ¢Ã…â€™Ã‚Âc ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÆ’Ã‚Â¦ÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€ÃƒÆ’Ã‚Â²i theo ngÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ‚Â¤n ngÃƒÆ’Ã…Â¸ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€Ãƒâ€šÃ‚Â» */}
      ...
      <section style={{ background: '#111814', padding: '36px 0', overflow: 'hidden' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: 16 }}>
          <Link href="/tools" style={{ fontSize: '0.75rem', color: SAGE, textDecoration: 'none', fontWeight: 500, opacity: 0.7 }}>44+ free tools ÃƒÅ½Ã¢â‚¬Å“ÃƒÆ’Ã‚Â¥ÃƒÆ’Ã¢â‚¬Â </Link>
        </div>
      </section>
      ...
      <section style={{ background: '#fafaf8', padding: '80px 24px', minHeight: 300, display: 'flex', alignItems: 'center' }}>
        <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center', width: '100%' }}>
          ...
          <div style={{ opacity: quoteVisible ? 1 : 0, transition: 'opacity 0.6s ease', minHeight: 110 }}>
            ...
            {currentQuote.author && (
              <p style={{ fontSize: '0.8rem', color: SAGE, fontWeight: 600 }}>ÃƒÅ½Ã¢â‚¬Å“ÃƒÆ’Ã¢â‚¬Â¡ÃƒÆ’Ã‚Â¶ {currentQuote.author}</p>
            )}
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#0c0e0c', padding: '80px 24px', minHeight: 300, display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', width: '100%', position: 'relative' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 24 }}>
            <span>ÃƒÅ½Ã¢â‚¬Å“ÃƒÆ’Ã…â€œÃƒÆ’Ã‚Â»ÃƒÂ¢Ã‹â€ Ã‚Â©ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢ÃƒÆ’Ã¢â‚¬Â¦</span>
            <span style={{ fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(240,239,235,0.25)' }}>Law and Justice ÃƒÂ¢Ã¢â‚¬ÂÃ‚Â¬ÃƒÂ¢Ã¢â‚¬Â¢Ã¢â‚¬â€œ From Read</span>
          </div>
          ...
          <p style={{ fontSize: '0.8rem', color: SAGE, fontWeight: 600, paddingLeft: 22 }}>ÃƒÅ½Ã¢â‚¬Å“ÃƒÆ’Ã¢â‚¬Â¡ÃƒÆ’Ã‚Â¶ {LAW_QUOTES[0].author}</p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', width: '100%' }}>
          ...
          <div style={{ opacity: appVisible ? 1 : 0, transition: 'opacity 0.5s ease' }}>
            ...
            <Link href={currentApp.href} style={{ display: 'inline-flex', padding: '9px 20px', background: currentApp.color, color: '#fff', borderRadius: 100, textDecoration: 'none', fontSize: '0.82rem', fontWeight: 600 }}>
              Explore {currentApp.name} ÃƒÅ½Ã¢â‚¬Å“ÃƒÆ’Ã‚Â¥ÃƒÆ’Ã¢â‚¬Â 
            </Link>
          </div>
      ...
      <section style={{ background: '#070908', padding: '90px 24px', textAlign: 'center', position: 'relative' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <Link href="/auth/register" style={{ display: 'inline-block', padding: '13px 34px', background: SAGE, color: '#fff', borderRadius: 100, textDecoration: 'none', fontWeight: 600, fontSize: '0.95rem' }}>
            Get started ÃƒÅ½Ã¢â‚¬Å“ÃƒÆ’Ã¢â‚¬Â¡ÃƒÆ’Ã‚Â¶ it's free
          </Link>
        </div>
      </section>
    </div>
